...
class R 
{
	...
	public static var GEM_TYPES_ARRAY:Array<GemTypes> = [GemTypes.CLAY, GemTypes.METAL, GemTypes.ROCK, GemTypes.WOOD, GemTypes.WATER, GemTypes.BROWN];
	
	public static var GRID_OFFSET_X:Float = 75;
	public static var GRID_OFFSET_Y:Float = 50;
	...
	//660,60
	public static var STATUS_OFFSET_X:Float = 660;
	public static var STATUS_OFFSET_Y:Float = 60;
